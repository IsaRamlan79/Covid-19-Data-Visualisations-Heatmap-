...
// legend({
//   color: d3.scaleSequential([0, 2800], d3.interpolateViridis),
//   title: "Temperature (°F)"
// })
// )});
  main.variable(observer()).define(["legend","d3"], function(legend,d3){return(
legend({
  color: d3.scaleSequential([0, 2800], d3.interpolateTurbo),
  title: "Daily Case(s)"
})
)});
//   main.variable(observer()).define(["legend","d3"], function(legend,d3){return(
...
## Implementation`
  ...
  main.variable().define("legend", ["d3","ramp"], function(d3,ramp){return(
function legend({
  color,
  title,
  tickSize = 6,
  ...
  main.variable().define("swatches", ["DOM","html","entity"], function(DOM,html,entity){return(
function swatches({
  color,
  columns = null,
  format = x => x,
...
.${id}::before {
  ...
  main.variable().define("entity", function(){return(
function entity(character) {
  return `&#${character.charCodeAt(0).toString()};`;
}
)});
  main.variable().define("ramp", ["DOM"], function(DOM){return(
